...
ALTER TABLE product_integration_mappings ADD COLUMN IF NOT EXISTS sku_produto TEXT REFERENCES produtos(sku) ON DELETE CASCADE;
ALTER TABLE product_integration_mappings ADD COLUMN IF NOT EXISTS integration_code TEXT;
ALTER TABLE product_integration_mappings ADD COLUMN IF NOT EXISTS product_type TEXT;
ALTER TABLE product_integration_mappings ADD COLUMN IF NOT EXISTS unit TEXT;
...
ALTER TABLE product_integration_mappings ADD COLUMN IF NOT EXISTS review_status TEXT;
ALTER TABLE product_integration_mappings ADD COLUMN IF NOT EXISTS raw_payload JSONB;
